...
public class Hotel extends Facility implements Comparable<Hotel>, Serializable {
	...
	// 부모클래스 생성자
	public Hotel(String type, String name, String address, String phone, String imagePath) {
	...
	public int hashCode() {
		...
		result = prime * result + ((useableRoom == null) ? 0 : useableRoom.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (price == null) {
			...
			return false;
		if (useableRoom == null) {
			if (other.useableRoom != null)
				return false;
		} else if (!useableRoom.equals(other.useableRoom))
			return false;
		return true;
	}
	...
	public String displayOnList() {
		return this.name + " " + this.grade + " ₩ " + this.price;
	}
