	...
	public static void main(String[] args) {
		...
		/*
		 # 문자열을 저장할 수 있는 데이터 타입 String
		   - 저장하고 싶은 문자를 겹따옴표("")에 담아 대입합니다.
		   - String은 기본 데이터 타입은 아니지만, 자주 쓰이기 때문에
		     기본 데이터 타입처럼 사용하빈다. (사실은 객체에요~)	 
		 */
		...
		System.out.println(s1 + s2 + " hahahahaha"); // my dream is a programmer hahahahaha
		...
		int day = 13;
		// 내 생일은 10월 13일 입니다.
		System.out.println("내 생일은 " + month + "월" + day + "일 입니다."); // 내 생일은 10월13일 입니다.
